...
@Component({
  ...
  template: `<div class="btn-group" role="group" aria-label="Basic mixed styles example" *ngIf="action !== 'bom'">
      <button
        type="button"
    ...
    <div class="btn-group" role="group" aria-label="Basic mixed styles example " *ngIf="action === 'bom' && params.node.group">
      <button
        type="button"
        (click)="onClick($event, 'view')"
        class="btn btn-sm"
