...
@Component({
  ...
  template: `<div class="btn-group" role="group" aria-label="Basic mixed styles example">
    ...
    <button type="button" (click)="onClick($event, 'production')" class="btn btn-sm" style="padding: 2px 1px 2px 1px; border:none;">
      <mat-icon mat-list-icon class="list-icon" style="margin-left: 3px; font-size: 18px; margin-top: 8px;"
...
export class ActionRendererComponent implements ICellRendererAngularComp {
  ...
  navigateToProductionAdd(): void {
    if (this.params?.navigateToProductionAdd) {
      this.params.navigateToProductionAdd(this.params.node.data);
    }
  }
}
